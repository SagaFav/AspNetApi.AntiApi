...
namespace Anti.Api.Model
{
    ...
    {
        private const string ERR_CODE_PARAM_MISSING = "400";
        ...
        public static void ValidateRequired(string name, object value)
        {
            if (value == null)
            {
                throw new AntiFakeException(ERR_CODE_PARAM_MISSING, string.Format(ERR_MSG_PARAM_MISSING, name));
            }
            else
            {
        ...
        public static void ValidateMaxLength(string name, string value, int maxLength)
        {
            ...
            {
                throw new AntiFakeException(ERR_CODE_PARAM_INVALID, string.Format(ERR_MSG_PARAM_INVALID, name));
            }
        }
        ...
        public static void ValidateObjectMaxListSize(string name, string value, int maxSize)
        {
            ...
            //if (value != null)
            //{
            //    IList list = JsonConvert.DeserializeObject(value) as IList;
